...
library(alluvial)
library(kableExtra)
setwd("C:/Users/james/OneDrive/Documents/Important_Files/Stat_ed_2018_papers/paper_0_bball_data/3_survey_data")



argu_df = read_csv('arguments.csv')
pre_df = read_csv('pre_survey.csv')
post_df = read_csv('post_survey.csv')
...
```{r clean_pre_post, echo=FALSE, message=FALSE, warning=FALSE}
## Change Column Names
...
pre_df = pre_df %>%
  separate(pre_date_time, c("pre_date", "pre_time"),sep = ' ') %>%
